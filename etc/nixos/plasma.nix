...
in {
  ...
  programs.plasma = {
    ...
    shortcuts = {
      ...
      "kwin"."Cube" = "Meta+Shift+W\\, Meta+C\\, ,none,Toggle Cube";
      "kwin"."Cycle Overview" = [ ];
      ...
      "kwin"."Window Fullscreen" = "\\, ,,Make Window Fullscreen";
    ...
    configFile = {
      ...
      "dolphinrc"."ExtractDialog"."DirHistory[$e]" = "$HOME/.local/share/Steam/steamapps/common/Fallout 2/";
      "dolphinrc"."ExtractDialog"."DirHistory\x5b$e\x5d" = "$HOME/.local/share/Steam/steamapps/common/Fallout 2/";
      ...
      "kcminputrc"."Libinput/2/10/TPPS\\/2 IBM TrackPoint"."PointerAcceleration" = 0.0;
