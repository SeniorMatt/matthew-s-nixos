...
in {
  ...
  programs.plasma = {
    ...
    shortcuts = {
      ...
      "kwin"."Window Close" = ["Meta+C" "Alt+F4\\, Alt+F4,Alt+F4,Close Window"];
    ...
    configFile = {
      ...
      "dolphinrc"."ExtractDialog"."1920x1080 screen: Height" = 660;
      ...
      "kdeglobals"."DirSelect Dialog"."DirSelectDialog Size" = "845,592";
      "kdeglobals"."DirSelect Dialog"."Splitter State" = "x00x00x00xffx00x00x00x01x00x00x00x02x00x00x00xa5x00x00x02xa8x00xffxffxffxffx01x00x00x00x01x00";
      ...
      "kwinrc"."Desktops"."Id_3" = "2ea62e39-36f9-48c4-be93-36a12382ddad";
      "kwinrc"."Desktops"."Number" = 3;
      "kwinrc"."Desktops"."Rows" = 1;
      "kwinrc"."NightColor"."Active" = true;
      "kwinrc"."NightColor"."LatitudeFixed" = 37.754055343511446;
      "kwinrc"."NightColor"."LongitudeFixed" = 94.20289003759399;
      ...
      "kwinrc"."Tiling/a746b084-54ea-4e31-8d71-3524edc77a9c/521ea49f-9bef-4ac8-85d5-e58c7e97e7d0"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"layoutDirection\":\"vertical\",\"tiles\":[{\"height\":0.4342592592592593},{\"height\":0.5657407407407407}],\"width\":0.4479166666666667},{\"width\":0.5520833333333333}]}";
    ...
    dataFile = {
      ...
      "kate/anonymous.katesession"."Document 0"."URL" = "admin:///etc/nixos/plasma.nix";
      "kate/anonymous.katesession"."Document 1"."URL" = "admin:///etc/nixos/home.nix";
      "kate/anonymous.katesession"."Document 2"."URL" = "admin:///etc/nixos/hyprland.nix";
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-H-Splitter" = "0,1046,0";
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-0-Splitter" = 494;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-1-Splitter" = 494;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-2-Splitter" = 1046;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-3-Splitter" = 758;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-V-Splitter" = "0,494,0";
      ...
      "kate/anonymous.katesession"."MainWindow0-Splitter 0"."Sizes" = 1046;
      ...
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 0"."CursorLine" = 13;
      ...
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 2"."CursorColumn" = 2;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 2"."CursorLine" = 28;
